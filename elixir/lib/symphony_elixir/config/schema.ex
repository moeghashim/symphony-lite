defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Agent do
    ...
    embedded_schema do
      ...
      field(:max_sessions_per_state_interval, :integer, default: 5)
    ...
    def changeset(schema, attrs) do
      ...
      |> cast(
        ...
        [
          ...
          :max_turns,
          :max_sessions_per_state_interval,
      ...
      |> validate_number(:max_sessions_per_state_interval, greater_than_or_equal_to: 0)
