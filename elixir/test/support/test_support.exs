defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    ...
    max_sessions_per_state_interval = Keyword.get(config, :max_sessions_per_state_interval)
    ...
    sections =
      [
        ...
        "  max_sessions_per_state_interval: #{yaml_value(max_sessions_per_state_interval)}",
